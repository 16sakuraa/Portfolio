...
const ImageSelect: React.FC<ImageSelect> = ({imgSrc1,imgSrc2,imgSrc3,imgSrc4}) => {
  ...
  return (
    <div className="mt-4 flex flex-row justify-center items-center gap-3">
      <img src={path} alt="imageAlt" className="h-[573px] w-[950px] rounded-xl" id="bigPic"></img>
      <div className="flex flex-col gap-3">
        <button type="button" onClick={() => handleImageClick(imgSrc1)}>
          <img src={imgSrc1} alt="imageAlt" className="h-[134px] w-[207px] rounded-xl" id="1"></img>
        </button>
        <button type="button" onClick={() => handleImageClick(imgSrc2)}>
          <img src={imgSrc2} alt="imageAlt" className="h-[134px] w-[207px] rounded-xl" id="2"></img>
        </button>
        <button type="button" onClick={() => handleImageClick(imgSrc3)}>
          <img src={imgSrc3} alt="imageAlt" className="h-[134px] w-[207px] rounded-xl" id="3"></img>
        </button>
        <button type="button" onClick={() => handleImageClick(imgSrc4)}>
          <img src={imgSrc4} alt="imageAlt" className="h-[134px] w-[207px] rounded-xl" id="4"></img>
        </button>
      </div>
    </div>
  );
